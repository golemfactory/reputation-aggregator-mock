...
async def main(golem, *, num_providers, task_size, random_fail_factor, task_timeout_factor):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--task-timeout-factor", type=int, default=600)
    ...
    run_golem_example(
        main(
            ...
            task_timeout_factor=args.task_timeout_factor,
        ),
